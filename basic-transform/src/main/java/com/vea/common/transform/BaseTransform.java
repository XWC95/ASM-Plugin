...
import com.vea.common.transform.ams.ClassLoaderHelper;
...
public class BaseTransform extends Transform {
    ...
    public void transform(Context context,
        ...
        for(TransformInput input : inputs) {
            ...
            // DirectoryInput有一个方法getChangedFiles()开获取一个Map<File, Status>集合，
            // 所以可以遍历这个Map集合，然后根据File对应的Status来对File进行处理。
